...
public class BookReservation {
    ...
    private boolean removeStudentFromWaitingList(Book book, String studentID) {
        ...
        for (int i = 1; i <= waitingList.getNumberOfEntries(); i++) {
            Student s = waitingList.getEntry(i);
    ...
    public String viewWaitingList(String bookID) {
        ...
        for (int i = 1; i <= book.getWaitingList().getNumberOfEntries(); i++) {
            Student student = book.getWaitingList().getEntry(i);
            output.append(i)
                  .append(". ")
    ...
    public String notifyNextStudent(String bookID) {
        ...
        Student nextStudent = book.getWaitingList().getEntry(1);
    ...
    public String notifyBookRemoval(String bookID) {
        ...
        int count = book.getWaitingList().getNumberOfEntries();
